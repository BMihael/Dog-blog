<?php
  ...
  if(isset($_POST['sendMessage'])){
    ...
    $querysendMessage = "INSERT INTO `contactmessage` (`firstName`, `lastName`, `email`, `country`, `message`, `user`) VALUES ('$firstName', '$lastName', '$email', '$country', '$message', '$id')";

    $resultSendMessage = mysqli_query($mysql, $querysendMessage);
    if($resultSendMessage == True){
